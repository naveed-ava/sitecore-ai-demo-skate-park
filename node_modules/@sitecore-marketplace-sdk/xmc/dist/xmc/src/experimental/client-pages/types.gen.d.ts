export declare namespace experimental_Pages {
    type AddPageVersionInput = {
        /**
    ...
    type CreatePageFromBlueprintInput = {
        /**
     ...
     */
    type TypeFilter = 'Pages' | 'Folders' | 'All';
    /**
     * The search filter type.
     */
    const TypeFilter: {
    ...
    type DeletePageError = DeletePageErrors[keyof DeletePageErrors];
    type DeletePageResponses = {
        /**
         * Success
         */
        200: boolean;
    };
    type DeletePageResponse = DeletePageResponses[keyof DeletePageResponses];
    type RetrievePageData = {
        body?: never;
        path: {
            /**
             * The page identifier.
    ...
    type RetrievePageError = RetrievePageErrors[keyof RetrievePageErrors];
    type RetrievePageResponses = {
        /**
         * Success
         */
        200: Page;
    };
    type RetrievePageResponse = RetrievePageResponses[keyof RetrievePageResponses];
    ...
    type UpdateFieldsError = UpdateFieldsErrors[keyof UpdateFieldsErrors];
    type UpdateFieldsResponses = {
        /**
         * Success
         */
        200: PageOperationResult;
    };
    type UpdateFieldsResponse = UpdateFieldsResponses[keyof UpdateFieldsResponses];
    type RetrievePageStateData = {
        body?: never;
        path: {
            /**
             * The page identifier.
    ...
    type RetrievePageStateError = RetrievePageStateErrors[keyof RetrievePageStateErrors];
    type RetrievePageStateResponses = {
        /**
         * Success
         */
        200: PageState;
    };
    type RetrievePageStateResponse = RetrievePageStateResponses[keyof RetrievePageStateResponses];
    type SearchData = {
        body?: never;
        path?: never;
        query?: {
    ...
    type SearchResponse = SearchResponses[keyof SearchResponses];
    type RetrieveInsertOptionsData = {
        body?: never;
        path: {
            /**
             * The page identifier.
    ...
    type RetrieveInsertOptionsErrors = {
        /**
         * Bad request
         */
        400: ProblemDetails;
    ...
    type RetrieveInsertOptionsError = RetrieveInsertOptionsErrors[keyof RetrieveInsertOptionsErrors];
    type RetrieveInsertOptionsResponses = {
        /**
         * Success
         */
        200: Array<PageInsertOption>;
    };
    type RetrieveInsertOptionsResponse = RetrieveInsertOptionsResponses[keyof RetrieveInsertOptionsResponses];
    type RetrievePageVersionsData = {
        body?: never;
        path: {
            /**
             * The page identifier.
    ...
    type RetrievePageVersionsErrors = {
        /**
         * Bad request
         */
        400: ProblemDetails;
    ...
    type RetrievePageVersionsError = RetrievePageVersionsErrors[keyof RetrievePageVersionsErrors];
    type RetrievePageVersionsResponses = {
        /**
         * Success
         */
        200: Array<Page>;
    };
    type RetrievePageVersionsResponse = RetrievePageVersionsResponses[keyof RetrievePageVersionsResponses];
    type AddPageVersionsData = {
        /**
    ...
    type AddPageVersionsError = AddPageVersionsErrors[keyof AddPageVersionsErrors];
    type AddPageVersionsResponses = {
        /**
         * Success
         */
        200: number;
    };
    type AddPageVersionsResponse = AddPageVersionsResponses[keyof AddPageVersionsResponses];
    type ListPageVariantsData = {
        body?: never;
        path: {
            /**
             * The page identifier.
    ...
    type ListPageVariantsErrors = {
        /**
         * Not found
         */
        404: ProblemDetails;
    };
    type ListPageVariantsError = ListPageVariantsErrors[keyof ListPageVariantsErrors];
    type ListPageVariantsResponses = {
        /**
         * Success
         */
        200: Array<string>;
    };
    type ListPageVariantsResponse = ListPageVariantsResponses[keyof ListPageVariantsResponses];
    ...
    type GetLivePageStateErrors = {
        /**
         * Not found
         */
        404: ProblemDetails;
    };
    type GetLivePageStateError = GetLivePageStateErrors[keyof GetLivePageStateErrors];
    type GetLivePageStateResponses = {
        /**
         * Success
         */
        200: unknown;
    ...
    type CreatePageError = CreatePageErrors[keyof CreatePageErrors];
    type CreatePageResponses = {
        /**
         * Success
         */
        200: PageOperationResult;
    };
    type CreatePageResponse = CreatePageResponses[keyof CreatePageResponses];
    type CreateBlueprintData = {
        /**
         * Input data containing properties of the page
         */
    ...
    type CreateBlueprintErrors = {
        /**
         * Bad request
         */
        400: ProblemDetails;
    };
    type CreateBlueprintError = CreateBlueprintErrors[keyof CreateBlueprintErrors];
    type CreateBlueprintResponses = {
        /**
         * Success
         */
        200: JobResponse;
    };
    type CreateBlueprintResponse = CreateBlueprintResponses[keyof CreateBlueprintResponses];
    type SaveLayoutData = {
        /**
    ...
    type SaveLayoutError = SaveLayoutErrors[keyof SaveLayoutErrors];
    type SaveLayoutResponses = {
        /**
         * Success
         */
        200: SavePageResult;
    };
    type SaveLayoutResponse = SaveLayoutResponses[keyof SaveLayoutResponses];
    type SaveFieldsData = {
        /**
    ...
    type SaveFieldsError = SaveFieldsErrors[keyof SaveFieldsErrors];
    type SaveFieldsResponses = {
        /**
         * Success
         */
        200: SavePageResult;
    };
    type SaveFieldsResponse = SaveFieldsResponses[keyof SaveFieldsResponses];
    type DuplicatePageData = {
        /**
         * Input data containing properties of the page
         */
    ...
    type DuplicatePageError = DuplicatePageErrors[keyof DuplicatePageErrors];
    type DuplicatePageResponses = {
        /**
         * Success
         */
        200: PageOperationResult;
    };
    type DuplicatePageResponse = DuplicatePageResponses[keyof DuplicatePageResponses];
    type RenamePageData = {
        /**
         * Input data containing properties of the page
         */
    ...
    type RenamePageError = RenamePageErrors[keyof RenamePageErrors];
    type RenamePageResponses = {
        /**
         * Success
         */
        200: PageOperationResult;
    };
    type RenamePageResponse = RenamePageResponses[keyof RenamePageResponses];
    type AddPageVersionData = {
        /**
    ...
    type AddPageVersionError = AddPageVersionErrors[keyof AddPageVersionErrors];
    type AddPageVersionResponses = {
        /**
         * Success
         */
        200: number;
    };
    type AddPageVersionResponse = AddPageVersionResponses[keyof AddPageVersionResponses];
    ...
    type TranslatePageError = TranslatePageErrors[keyof TranslatePageErrors];
    type TranslatePageResponses = {
        /**
         * Success
         */
        200: string;
    };
    type TranslatePageResponse = TranslatePageResponses[keyof TranslatePageResponses];
    type DeletePageVersionsData = {
        body?: never;
        path: {
            /**
             * The page identifier.
    ...
    type DeletePageVersionsError = DeletePageVersionsErrors[keyof DeletePageVersionsErrors];
    type DeletePageVersionsResponses = {
        /**
         * Success
         */
        200: number;
    };
    type DeletePageVersionsResponse = DeletePageVersionsResponses[keyof DeletePageVersionsResponses];
    type ClientOptions = {
