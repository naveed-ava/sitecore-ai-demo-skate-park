export declare namespace experimental_ContentTransfer {
    type CreateContentTransferData = {
        body: {
            configuration: {
                dataTrees?: Array<{
                    /**
    ...
    type CreateContentTransferErrors = {
        /**
    ...
    type CreateContentTransferResponses = {
        /**
         * Transfer creation started.
         */
        202: unknown;
    };
    type GetContentTransferStatusData = {
        body?: never;
        path: {
            /**
    ...
    type GetContentTransferStatusErrors = {
        /**
         * Invalid transfer id.
         */
        400: unknown;
    ...
    type GetContentTransferStatusResponses = {
        /**
    ...
    type GetContentTransferStatusResponse = GetContentTransferStatusResponses[keyof GetContentTransferStatusResponses];
    type GetChunkData = {
        body?: never;
        path: {
            /**
    ...
    type GetChunkResponse = GetChunkResponses[keyof GetChunkResponses];
    type SaveChunkData = {
        body: Blob | File;
        path: {
            /**
    ...
    type SaveChunkResponses = {
        /**
         * The chunk is pushed.
         */
        201: unknown;
    };
    type CompleteChunkSetTransferData = {
        body?: never;
        path: {
            /**
             * ID of the transfer.
    ...
    type CompleteChunkSetTransferErrors = {
        /**
    ...
    type CompleteChunkSetTransferResponses = {
        /**
    ...
    type CompleteChunkSetTransferResponse = CompleteChunkSetTransferResponses[keyof CompleteChunkSetTransferResponses];
    type DeleteContentTransferData = {
        body?: never;
        path: {
            /**
    ...
    type DeleteContentTransferErrors = {
        /**
         * Invalid transfer id.
         */
        400: unknown;
    ...
    type DeleteContentTransferResponses = {
        /**
         * Transfer cleanup started.
         */
        202: unknown;
    };
    type ConsumeFileData = {
        body?: never;
        path?: never;
        query: {
            /**
    ...
    type ConsumeFileResponses = {
        /**
         * Raif file consuming started.
         */
        202: unknown;
    };
    type GetBlobStateData = {
        body?: never;
        path?: never;
        query: {
            /**
    ...
    type GetBlobStateResponse = GetBlobStateResponses[keyof GetBlobStateResponses];
    type ClientOptions = {
